...
class ActionBlockDialog(wx.Dialog):
    ...
    def __init__(self, parent):
        super().__init__(parent, title=_('Edit action block properties'))
        ...
        self.ActionsGrid = CustomGrid(
            self, size=wx.Size(-1, 250), style=wx.VSCROLL)
        ...
        self.ColAlignements = [wx.ALIGN_LEFT, wx.ALIGN_LEFT,
    ...
    def SetVariableList(self, list):
        self.VariableList = "," + \
            ",".join([variable.Name for variable in list])
